...
ax[0].set_xlabel("$k\eta_0$", fontsize = 18)
ax[0].set_ylabel("$\Theta_\ell(k)$", fontsize = 17)
...
ax[1].set_xlabel("$k\eta_0$", fontsize = 18)
ax[1].set_ylabel("$\Theta_\ell(k)$", fontsize = 17)
