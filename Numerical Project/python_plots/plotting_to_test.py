...
plt.ylim(10**-1, 10**3)
plt.yscale("log")
plt.savefig("python_plots/plots/Hp_of_x_plot.pdf")
plt.show()
# #-----------------------------------------------------------------------------------------------------------------------
...
plt.savefig("python_plots/plots/eta_plot.pdf")
plt.show()
# #-----------------------------------------------------------------------------------------------------------------------
...
plt.ylabel(r"$\frac{\eta(x) \mathcal{H}(x)}{c}$", fontsize = 18)
plt.xlim(-13,0)
plt.ylim(0.75, 3)
plt.legend(fontsize = 16)
plt.savefig("python_plots/plots/eta_times_Hp_divided_by_c.pdf")
plt.show()
# #-----------------------------------------------------------------------------------------------------------------------
...
plt.savefig("python_plots/plots/dHpdx_of_x_divided_by_Hp.pdf")
plt.show()
# #-----------------------------------------------------------------------------------------------------------------------
...
plt.legend(fontsize = 16)
plt.savefig("python_plots/plots/double_derivative_test.pdf")
plt.show()
...
plt.savefig("python_plots/plots/density_domination.pdf")
plt.show()
# #-----------------------------------------------------------------------------------------------------------------------
