...
# plt.plot(x, Hp_of_x_adjusted, color = "#4cc9f0")
...
# plt.plot(x, eta_of_x_adjusted, color = "#4cc9f0")
...
# plt.plot(x, ((eta_of_x * Hp_of_x)/c), color = "#4cc9f0", label = "Numerically calculated")
# plt.plot(x_array_for_1, y_array_1, color = "#D55E00", linestyle = "dashed", label = "Radiation dominated")
...
# plt.plot(x, (dHpdx_of_x / Hp_of_x), "#4cc9f0", label = "Calculated")
...
# plt.plot(x, (ddHpddx_of_x / Hp_of_x), color = "#4cc9f0", label = "Calculated") 
# plt.plot(x_array_for_1_first, y_array_1_first, color = "#D55E00", linestyle = "dashed", label = "Radiation dominated")
...
plt.plot(x, OmegaR+OmegaNu, color = "#1b8a5a", label = "$\Omega_{Relativistic}$ = $\Omega_{\gamma}$ + $\Omega_{\\nu}$")
plt.plot(x, OmegaB+OmegaCDM, color = "#1d4877", label = "$\Omega_{Matter}$ = $\Omega_{b}$ + $\Omega_{CDM}$")
plt.plot(x, OmegaLambda, color = "#f68838", label = "$\Omega_{\Lambda}$")
plt.vlines(x = -8.13814, ymin = 0, ymax = 1, color = "#c80815", linestyle = "dashed", label = "Matter - radiation \n equality")
plt.vlines(x = -0.255255, ymin = 0, ymax = 1, color = "#be2ed6", linestyle = "dashed", label = "Matter - dark energy \n equality")
...
# plt.plot(x,((eta_of_x_derivative*Hp_of_x)/const.c))
# plt.show()